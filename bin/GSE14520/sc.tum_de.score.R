...
# Set directories
dir_exp <- "exp/GSE14520/sharma_aiz.tum_score/";
...
k <- de.k[,"logFC"] > 1 & de.k[,"adj.P.Val"]  < 0.05
tum_genes <- de.k[k,"ens"]
# 335 significant up-regulated genes
...
# box plot of tum enr scores (main)
