...
#$ -j y
#$ -pe shared 8
#$ -l h_data=4G,h_vmem=36G,h_rt=8:00:00,highp
#$ -M malvarez@mail
...
dir_marker <- "exp/d_sct_cca_all/hep1/markers/"; create_dir(dir_marker)
dir_plot <- "exp/d_sct_cca_all/hep1/plots/"; create_dir(dir_plot)
...
# Subset
k <- seur@meta.data$Group == "Hepatocyte"
...
dir_out <- "data/processed/d_sct_cca_all/hep1/"; create_dir(dir_out)
...
# res1 clusters 10 (immune) and 12 (endo) have > 50% hepatocyte markers.
