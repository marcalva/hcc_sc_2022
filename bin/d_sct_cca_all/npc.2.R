...
# Cluster non-hepatocytes step 2
...
seur <- readRDS("data/processed/d_sct_cca_all/npc1/seur.cca.rds")
...
# Remove droplets from res1 clusters 1 and 6
k <- seur$integrated_snn_res.1 %in% c(1, 6)
...
seur_s.l <- lapply(seur_s.l, SCTransform, vars.to.regress = "pct.hep")
